...
#define UTIL_USE_PMIC                     0
#define UTIL_PMIC_I2C_PORT
#define UTIL_PMIC_I2C_SCL_PIN
#define UTIL_PMIC_I2C_SCL_GPIO_PORT
#define UTIL_PMIC_I2C_SCL_AF
#define UTIL_PMIC_I2C_SDA_PIN
#define UTIL_PMIC_I2C_SDA_GPIO_PORT
#define UTIL_PMIC_I2C_SDA_AF
