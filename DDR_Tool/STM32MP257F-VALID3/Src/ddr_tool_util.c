...
void UART_Config(void)
{
  ...
  COM_Init.BaudRate   = MX_UART_BAUDRATE;
  COM_Init.Parity     = (COM_ParityTypeDef)MX_UART_PARITY;
  COM_Init.StopBits   = (COM_StopBitsTypeDef)MX_UART_STOPBITS;
  COM_Init.WordLength = MX_UART_WORDLENGTH;
  COM_Init.HwFlowCtl  = (COM_HwFlowCtlTypeDef)MX_UART_HWFLOWCTL;
