      ...
      if (hi2c->hdmatx != NULL)
      {
        ...
        if ((hi2c->hdmatx->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST)
        {
          if (hi2c->hdmatx->LinkedListQueue != NULL)
          {
            ...
            hi2c->hdmatx->LinkedListQueue->Head->LinkRegisters[NODE_CSAR_DEFAULT_OFFSET] = (unsigned long)pData;

            /* Set DMA destination address */
            hi2c->hdmatx->LinkedListQueue->Head->LinkRegisters[NODE_CDAR_DEFAULT_OFFSET] \
              = (unsigned long)&hi2c->Instance->TXDR;
        ...
        {
          dmaxferstatus = HAL_DMA_Start_IT(hi2c->hdmatx, (unsigned long)pData, (unsigned long)&hi2c->Instance->TXDR,
                                           hi2c->XferSize);
        }
      }
      else
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      if (hi2c->hdmarx != NULL)
      {
        ...
        if ((hi2c->hdmarx->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST)
        {
          if (hi2c->hdmarx->LinkedListQueue != NULL)
          {
            ...
            hi2c->hdmarx->LinkedListQueue->Head->LinkRegisters[NODE_CSAR_DEFAULT_OFFSET] \
              = (unsigned long)&hi2c->Instance->RXDR;

            /* Set DMA destination address */
            hi2c->hdmarx->LinkedListQueue->Head->LinkRegisters[NODE_CDAR_DEFAULT_OFFSET] = (unsigned long)pData;
        ...
        {
          dmaxferstatus = HAL_DMA_Start_IT(hi2c->hdmarx, (unsigned long)&hi2c->Instance->RXDR, (unsigned long)pData,
                                           hi2c->XferSize);
        }
      }
      else
      ...
      if (hi2c->hdmatx != NULL)
      {
        ...
        if ((hi2c->hdmatx->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST)
        {
          if (hi2c->hdmatx->LinkedListQueue != NULL)
          {
            ...
            /* Set DMA source address */
            hi2c->hdmatx->LinkedListQueue->Head->LinkRegisters[NODE_CSAR_DEFAULT_OFFSET] = (unsigned long)hi2c->pBuffPtr;
        ...
        else
        {
          dmaxferstatus = HAL_DMA_Start_IT(hi2c->hdmatx,
                                           (unsigned long)hi2c->pBuffPtr, (unsigned long)&hi2c->Instance->TXDR,
                                           hi2c->XferSize);
        }
      }
      else
  ...
  else
  {
    ...
    if ((hi2c->hdmatx->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST)
    {
      if (hi2c->hdmatx->LinkedListQueue != NULL)
      {
        ...
        /* Set DMA destination address */
        hi2c->hdmatx->LinkedListQueue->Head->LinkRegisters[NODE_CDAR_DEFAULT_OFFSET] = (unsigned long)&hi2c->Instance->TXDR;
    ...
    {
      dmaxferstatus = HAL_DMA_Start_IT(hi2c->hdmatx, (unsigned long)hi2c->pBuffPtr, (unsigned long)&hi2c->Instance->TXDR,
                                       hi2c->XferSize);
    }
  ...
  else
  {
    ...
    if ((hi2c->hdmarx->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST)
    {
      if (hi2c->hdmarx->LinkedListQueue != NULL)
      {
        ...
        /* Set DMA source address */
        hi2c->hdmarx->LinkedListQueue->Head->LinkRegisters[NODE_CSAR_DEFAULT_OFFSET] = (unsigned long)&hi2c->Instance->RXDR;

        /* Set DMA destination address */
        hi2c->hdmarx->LinkedListQueue->Head->LinkRegisters[NODE_CDAR_DEFAULT_OFFSET] = (unsigned long)hi2c->pBuffPtr;
    ...
    {
      dmaxferstatus = HAL_DMA_Start_IT(hi2c->hdmarx, (unsigned long)&hi2c->Instance->RXDR, (unsigned long)hi2c->pBuffPtr,
                                       hi2c->XferSize);
    }
